...
import study.spring.wellcom.model.NoMemberLogin;
...
public class NoMemberLoginTest {
	...
	public void testA() {
		...
		NoMemberLogin input = new NoMemberLogin();
		input.setNo_member_id(1);
		sqlSession.selectOne("NoMemberLoginMapper.selectItem", input);
	}
